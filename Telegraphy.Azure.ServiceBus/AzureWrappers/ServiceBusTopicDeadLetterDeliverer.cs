...
namespace Telegraphy.Azure
{
    ...
    {
        public ServiceBusTopicDeadLetterDeliverer(string connectionString, string topicName, Microsoft.Azure.ServiceBus.RetryPolicy retryPolicy = null)
              : base(connectionString, EntityNameHelper.FormatDeadLetterPath(topicName), false, retryPolicy)
        {
            this.topic = topicName;
        }

        public ServiceBusTopicDeadLetterDeliverer(string connectionString, string topicName, string subscriptionName, Microsoft.Azure.ServiceBus.RetryPolicy retryPolicy = null)
